...
export default function SourcingConsultant(){
    const registerUser = async event => {
        ...
        xhttp.open("Post", 'https://bmelectrician.com/yoma/wp-json/contact-form-7/v1/contact-forms/4545/feedback');
    ...
    return(
        <>
        <Head>
         <title>Sourcing Consultant - Yomamultinational</title>
         <meta name="description" content=""/>
      </Head>

        <section>
          <img className="img100" src="/assets/img/banner/sourcing-consultant.jpg"/>
        </section>
        
        <section className="what-we-do bg-lighter pt-40 rpt-40 pb-40 rpb-30">
            <div className="container">
                <div className="section-title text-center mb-35">
                <h3 className="h3themecolor">Benefits for freelancer or sourcing consultant</h3> 
                </div>
            ...
            <div className="container">
                <div className="row align-items-center">                    
                    <div className="col-lg-12">
                        ...
                        <h3 className="h3themecolor">Expand earning opportunities using:</h3>
                        <img src="/assets/img/sor-con.png" alt="About"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section className="what-we-do pt-50 rpt-40 pb-40 rpb-30 bg-lighter">
            <div className="container">
                <div className="section-title text-center mb-35">
                ...
                <div className="row justify-content-center">
                    <div className="col-sm-6 col-md-6">
                        ...
                        <div className="feature-content">                            
                            <p>People who are currently working/not but have completed their graduation can become a sourcing consultant.</p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-6">
                        ...
                        <div className="feature-content">                            
                            <p>People who are working as HR Managers and HR executives in their current organization.</p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-6">
                        ...
                        <div className="feature-content">                            
                            <p>People who are running their own business and consultancies can also become sourcing consultants.</p>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-6 col-md-6">
                        ...
                        <div className="feature-content">                            
                            <p>Anyone having experience, expertise and connections relevant to this profile can apply.</p>
                        </div>
                        </div>
                    </div>
